...
<tr style="cursor: pointer;">
    ...
    <td class="text-center">
        ...
        @if($item->etat == "payer")
            {{ date('d-m-Y', strtotime($item->date_paiment)) }}
        @endif
    </td>
    <td class="text-center">
        {{-- request()->segment(3) --}}
        ...
        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
            <div class="btn-group" role="group">
                ...
                <div class="dropdown-menu">
                    {{-- <a href="#" class="dropdown-item dropdownActive">Voir la demande</a>
                  ...
                  {{-- data-toggle="modal" data-target="#detailsInfos{{ $item->id }}" --}}
                    @if($item->etat == "traiter" || $item->etat == "payer" || $item->etat == "valider")
