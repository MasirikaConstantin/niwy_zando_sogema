...
<style>
    ...
    select {
        background-color: red !important; /* Couleur de fond */
        color: #D71212; /* Couleur du texte */
        border: 1px solid #cccccc; /* Couleur de la bordure */
    }
</style>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="about">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="piece_identite" class="form-label">Piece D'identite</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mystyleInput @error('numero_national') is-invalid @enderror" name="numero_national" id="numero_national" value="{{old('numero_national')}}" placeholder="piece identite date expiration" />
                                ...
                                <div class="col-md-6" style="display: none" id="id_date_passport">
                                    <div class="form-group">
                                        <label for="piece_identite_date_expiration" class="form-label">Date expiration passport</label>
                            ...
                            <div id="removeRow0" class="row mt-3">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <select name="place0" id="place0" onchange="getPrixPlace('0');" disabledM class="form-control selected2" required>
                                        <option value="">--Choisir--</option>
...
<script>
    ...
    function getEmplacementByIdArticle(idSecteurActivite) {
        ...
        .then(function(response) {
            let produits = response.data;   
            let countEmplacement = produits.length;
                 
            // let articleQuantite = document.getElementById('articleQuantite'+idSecteurActivite).innerHTML = countEmplacement;
            //let articleQuantite = document.getElementById('articleQuantite'+idSecteurActivite).innerHTML = countEmplacement;
            document.getElementById('quantiteStock'+idSecteurActivite).style.display = "block";
