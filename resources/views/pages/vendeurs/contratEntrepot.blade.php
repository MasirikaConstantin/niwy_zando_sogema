        ...
        <div class="container" style="padding-left: 50px; padding-right: 50px;">
            ...
            <div class="row justify-content-center page-break">
                ...
                <div class="col-12">
                    ...
                    <p>
                        Il est convenu d’un bail professionnel de type commercial, conformément aux dispositions des articles 101 à 134 de l’Acte Uniforme OHADA portant sur le droit commercial général, pour les locaux (entrepôts) dont la désignation suit.
                    </p>
                    ...
                    <p>Le présent contrat a pour objet la location des entrepôts ainsi déterminés :</p>
                    <p class="ml-5">
                        <strong>1.</strong> 
                        <span style="border-bottom: 1px solid #000;">Identification des lieux loués</span> <br />
                        <strong style="color: #ffffff">..</strong> <strong><span>Entrepôts</span></strong> <br />

                        <strong style="color: #ffffff">...</strong>
                        <strong style="color: #ffffff">..</strong>
                        <strong style="color: #ffffff">..</strong>
                        <span>
                            Le(s) lot(s) entrepôts  n° 
                    ...
                    <p>
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                <tr>
                                    <td>Superficie de l’entrepôt</td>
                                    <td>Nombre</td>
                                </tr>
                                @forelse($vendeurDemande as $place) 
                                <tr>
                                    <td>{{$place->typeDimension}}</td>
                    ...
                    <p class="ml-5">
                        <strong>2.</strong> 
                        <span style="border-bottom: 1px solid #000;">Destination des entrepôts loués</span>
                    </p>

                    <p>
                        Les entrepôts sont loués pour un usage commercial.
                    </p>
                ...
                <div class="col-12">
                    ...
                    <div style="padding-left: 25px;">
                        <ol>
                            <li>
                                <p>
                                    Date de prise d’effet du contrat : date de la mise à disposition par le BAILLEUR des entrepôts loués.
                                </p>
                            </li>
                            <li>
                                <p>
                ...
                <div class="col-12">
                    ...
                    <p>
                        Le montant du loyer mensuel est de    USD pour chaque entrepôt, hors charges et hors taxes.
                    </p>

                    <p>
                        A la souscription, le paiement initial à la date de prise d’effet du bail pour le loyer de l’entrepôt ou de l’ensemble du lot d’entrepôts loués se fait en une fois pour sept (7) mois, comprenant six (6) mois de garantie locative et un (1) mois de loyer anticipatif. 
                    </p>
                    ...
                    <p>
                        Le LOCATAIRE s’oblige à payer, chaque trimestre et de manière anticipative, une provision sur les charges d’électricité, eau, poubelle et entretien) selon les calculs du syndic désigné, suivant le montant du loyer mensuel et des besoins relatifs à chaque entrepôt loué.
                    </p>
                ...
                <div class="col-12">
                    ...
                    <div style="padding-left: 10px;">
                        <ol type="a">
                            <li>
                                Le BAILLEUR s’oblige à remettre au LOCATAIRE les entrepôts loués en bon état de réparation de toute espèce
                            </li>
                            <li>
                    ...
                    <p>
                        Le LOCATAIRE peut céder les entrepôts loués aux sous-locataires commerçants de son choix, moyennant l’obligation pour lui de porter à la connaissance du BAILLEUR, dans le mois de la sous-location, l’identité complète du (des) sous-locataire(s) avec, le cas échéant, leur adresse (siège) et numéro RCCM.
                    </p>
                    <p>
                        Le LOCATAIRE demeure garant de tous ses sous-locataires et il répond solidairement avec eux et tous les occupants successifs, des dommages causés aux entrepôts loués, conformément au droit commun.
                    </p>
                    <p>
                    ...
                    <p>
                        Par contre, en cas de destruction totale ou partielle des entrepôts  loués due à la faute d’une des parties, le présent bail pourra être résilié à la demande de l’autre partie, sans préjudice du recours de la partie victime contre celle à la faute de qui la destruction serait imputable.
                    </p>
