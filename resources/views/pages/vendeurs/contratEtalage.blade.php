        ...
        <div class="container" style="padding-left: 50px; padding-right: 50px;">
            ...
            <div class="row justify-content-center page-break">
                ...
                <div class="col-12">
                    ...
                    <p>
                        Il est convenu d’un bail professionnel de type commercial, conformément aux dispositions des articles 101 à 134 de l’Acte Uniforme OHADA portant sur le droit commercial général, pour les étals dont la désignation suit.
                    </p>
                    ...
                    <p>Le présent contrat a pour objet la location des étals ainsi déterminés :</p>
                    <p class="ml-5">
                        <strong>1.</strong> 
                        <span style="border-bottom: 1px solid #000;">Identification des lieux loués</span> <br />
                        <strong style="color: #ffffff">..</strong> <strong><span>Étal :</span></strong> <br />
                    ...
                    <p>
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                <tr>
                                    <td style="font-weight: bold; text-align: center;">Dimension de l’étal</td>
                ...
                <div class="col-12">
                    ...
                    <div style="padding-left: 25px;">
                        <ol>
                            <li>
                                <p>
                                    Date de prise d’effet du contrat : date de la mise à disposition par le BAILLEUR des étals loués.
                                </p>
                            </li>
                            <li>
                                <p>
                ...
                <div class="col-12">
                    ...
                    <p>
                        Le montant du loyer mensuel est <strong style="font-weight: bold;"> 60 USD</strong> pour chaque étal.
                    </p>

                    <p>
                        A la souscription, le paiement initial à la date de prise d’effet du bail pour le loyer des étals ou de l’ensemble du lot des étals loués se fait en une fois pour sept (7) mois, comprenant six (6) mois de garantie locative et un (1) mois de loyer anticipatif. 
                    </p>
                    ...
                    <p>
                        Le loyer peut être révisé après chaque terme de 3 ans, moyennant notification préalable au LOCATAIRE, en fonction de l’évolution générale des prix de l’immobilier dans la ville de Kinshasa ou des loyers couramment pratiqués dans d’autres espaces commerciaux pour des étals similaires.
                    </p>
                    ...
                    <p>
                        Le LOCATAIRE s’oblige à payer, chaque mois les charges d’électricité, d’eau, de poubelle et d’entretien selon les calculs du syndic désigné.
                    </p>
                ...
                <div class="col-12">
                    ...
                    <div style="padding-left: 10px;">
                        <ol type="a">
                            <li>
                                Le BAILLEUR s’oblige à remettre au LOCATAIRE les étals loués en bon état de réparation de toute espèce
                            </li>
                            <li>
                    ...
                    <div style="padding-left: 10px;">
                        <ol type="a">
                            ...
                            <li>
                                Le LOCATAIRE donnera accès et laissera visiter les étals durant les six mois qui précéderont son départ, le BAILLEUR pouvant apposer durant cette période, tous panneaux publicitaires à l’emplacement de son choix à l’effet d’une nouvelle location.
                            </li>
                            <li>
                    ...
                    <p>
                        Le LOCATAIRE peut céder les étals loués aux sous-locataires commerçants de son choix, moyennant l’obligation pour lui de porter à la connaissance du BAILLEUR, dans le mois de la sous-location, l’identité complète du (des) sous-locataire(s) avec, le cas échéant, leur adresse (siège) et numéro RCCM.
                    </p>
                    <p>
                        Le LOCATAIRE demeure garant de tous ses sous-locataires et il répond solidairement avec eux et tous les occupants successifs, des dommages causés aux étals loués, conformément au droit commun.
                    </p>
                    <p>
                    ...
                    <p>
                        Par contre, en cas de destruction totale ou partielle des étals loués due à la faute d’une des parties, le présent bail pourra être résilié à la demande de l’autre partie, sans préjudice du recours de la partie victime contre celle à la faute de qui la destruction serait imputable.
                    </p>
                ...
                <div class="col-12">
                    ...
                    <div style="padding-left: 10px;">
                        <ul  style="list-style-type: none;">
                            <li>- L’état des lieux des étals loués ;</li>
                            <li>
