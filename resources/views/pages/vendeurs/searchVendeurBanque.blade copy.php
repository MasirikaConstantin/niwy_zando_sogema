    ...
    <div class="row justify-content-center">
        <div class="col-md-9 card">
            <form id="formSend" action="{{route('searchVendeurStore')}}" method="get">
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <input type="text" name="searchForm" id="searchForm" class="form-control @error('searchForm') is-invalid @enderror" value="KN/ZD/2023/" placeholder="code unique" aria-describedby="emailHelp" />
                        @error('searchForm')
