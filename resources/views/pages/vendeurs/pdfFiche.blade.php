						...
						<div class="invoice-header">
							...
							<div class="row justify-content-center mb-3" style="margin-top: 100px; position: relative !important;">
								...
								<div class="col-3 bg-successM">
									...
									{{$qrcodeifos}}
									<p class="bg-dangerM">{{$vendeur->code_unique}}</p>
								</div>
							</div>
							<!-- photo -->
						</div>
					...
					<div class="card-body" style="margin-top: 35px;">
						...
						<div class="row pl-4 pr-4">
							<div class="col-md-12">
								...
								<div class="mb-3" style="display: flex; flex-direction: row; align-items: center;">
									<div><strong class="fontSizeTitle">Commune</strong></div>
									<div style="flex-grow: 4; padding-bottom: 0 !important; border-bottom: 2px dotted #000;">:<span class="fontSizeInfo ml-3">{{$vendeur->commune}}</span></div>
								</div>
								...
								@if($vendeur->rccm_patente == "patente")
									<div class="mb-3" style="display: flex; flex-direction: row; align-items: center;">
								...
								@if($vendeur->piece_identite == "passport")
									<div class="mb-3" style="display: flex; flex-direction: row; align-items: center;">
										<div><strong class="fontSizeTitle">numero piece d'identite/passeport</strong></div>
										<div style="flex-grow: 4; padding-bottom: 0 !important; border-bottom: 2px dotted #000;">:<span class="fontSizeInfo ml-3">{{$vendeur->numero_national}}</span></div>
									</div>
								...
								@if($vendeur->piece_identite == "Carte d'électeur")
									<div class="mb-3" style="display: flex; flex-direction: row; align-items: center;">
										<div><strong class="fontSizeTitle">numero carte d'électeur</strong></div>
										<div style="flex-grow: 4; padding-bottom: 0 !important; border-bottom: 2px dotted #000;">:<span class="fontSizeInfo ml-3">{{$vendeur->numero_national}}</span></div>
									</div>
								@endif
