    ...
    <div class="row justify-content-center">
        <div class="col-sm-12 col-md-12 col-lg-10">
            <div class="row mt-4 pl-4 pr-3 mb-2" style="display: flex; flex-direction: row; align-items: center; justify-content: space-between ;">
                <div>
                    <h2 style="font-weight: bold;">Statistique place details</h2>
                </div>
            </div>
                        ...
                        <table id="myTabable" class="table table-striped table-bordered nowrap">
                            <thead>
                                <tr >
                                    ...
                                    <th class="text-center" style="font-size: 18px;">{{ __('Numéro')}}</th>
...
<script>
    ...
    function getDataStatistiquePlace() {
        ...
        axios.get("{{route('placeDetailsEmplacement', $idPlace)}}",{
            headers: {
